...
%Typeset Package for accents
\usepackage[utf8]{inputenc}

%package to get small letter numbering
...
%
\makeatletter
\newenvironment{section}{\@startsection
       {section}
       {1}
       {-.2em}
...
\lhead{Grégoire Lurton}
\chead{}
\rhead{\thepage}
\lfoot{\small\scshape CSE 590}
\cfoot{}
\rfoot{\footnotesize Proposal}
...
The latest advances in population mapping are geared towards the production of density surfaces, presenting a continuous description of where populations live on a territory%\cite{linard2012population}.
This new approach is made possible by the availability of large aggregate datasets for land use, and other usable covariates%\cite{linard2011assessing}
...
%\newpage
%\bibliography{'../../../../phd_proposal/bibliographie.bib'}
